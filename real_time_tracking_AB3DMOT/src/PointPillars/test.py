...
if __name__ == '__main__':
    ...
    parser.add_argument('--pc_path',default='/home/milab20/PycharmProjects/Pointpillar/PointPillars/dataset/demo_data/val/000134.bin', help='your point cloud path')
    parser.add_argument('--calib_path', default='/home/milab20/PycharmProjects/Pointpillar/PointPillars/dataset/demo_data/val/000134.txt', help='your calib file path')
    parser.add_argument('--gt_path', default='/home/milab20/PycharmProjects/Pointpillar/PointPillars/dataset/demo_data/val/000134_gt.txt', help='your ground truth path')
    parser.add_argument('--img_path', default='/home/milab20/PycharmProjects/Pointpillar/PointPillars/dataset/demo_data/val/000134.png', help='your image path')
